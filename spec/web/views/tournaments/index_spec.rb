...
describe Web::Views::Tournaments::Index do
  let(:exposures) { Hash[tournaments: []] }
  let(:template)  { Hanami::View::Template.new('apps/web/templates/tournaments/index.html.haml') }
  let(:view)      { Web::Views::Tournaments::Index.new(template, exposures) }
